...
### Documentación Base
- [ ] Revisar `_patron/` y adaptarlos si es necesario
...
- [ ] Revisar _patron (Claude los lee automáticamente)
...
Ver `_patron/01_Estructura_Tecnica/` para requisitos completos.
