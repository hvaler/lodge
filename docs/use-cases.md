...
| UC-07 | The exchange student | all six, two adapters | essential |
...
- **Acceptance:** No occupied, booked or out-of-hours room is ever listed, and the answer lands inside the latency budget.
- **Priority:** essential
...
- **Flow:** The active adapter is switched; the same six tools resolve against a different data source and a different language.
