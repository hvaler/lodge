...
| [`management/`](management) | the video script and the submission text |

The *why* behind each technical decision is in [`_hilo/DECISIONES.md`](../_hilo/DECISIONES.md),
which is in Spanish — it is the project's own working record rather than documentation for adopters.
